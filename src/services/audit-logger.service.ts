...
import { formatAuditLogJSON, StructuredLogPayload } from '../utils/log-formatter.utils';
...
export const AuditLoggerService = {
     ...
     */
    async logEvent(payload: StructuredLogPayload): Promise<AuditLogRecord | null> {
     ...
     */
    async generateReport(params: AuditLogSearchParams): Promise<AuditLogRecord[]> {
